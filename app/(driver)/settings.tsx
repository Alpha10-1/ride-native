  ...
  return (
    <Screen>
      ...
      >
        ...
        <RowItem icon="document-text-outline" title="Documents" subtitle="License, vehicle registration" onPress={() => router.push("/(driver)/verification")} />
        ...
        <RowItem icon="card-outline" title="Payout method" subtitle="Bank account" onPress={() => router.push("/(driver)/payout-method")} />
